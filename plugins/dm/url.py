            ...
            if url.startswith(tuple(links)):
                ...
                try:
                    ...
                    if directDlLink:
                        ...
                        if "drive.google" in url:
                            ...
                            if content_disposition:
                                ...
                                if match:
                                    ...
                                    outputName = response.headers.get('Content-Disposition').split(';')[-1].strip().split('=')[-1].replace('"', '')
                            else:
                        ...
                        telegramCan = True if total_size < 20000000 or "drive.google" not in url else False
                        if not telegramCan:
                    ...
                    try: await data.edit(text=tTXT, reply_markup=tBTN)
                    except Exception: pass
