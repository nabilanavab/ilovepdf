...
BACKGROUND_L = {
        1 : { "isColor" : True, "code" : (255, 255, 255), 'position' : [20, 10] },
        2 : { "isColor" : True, "code" : (0, 0, 0), 'position' : [20, 10] },
        3 : { "isColor" : True, "code" : (128, 128, 128), 'position' : [20, 10] },
        4 : { "isColor" : False, "code" : f"{path}/IMAGES/notebook.png", 'position' : [20, 10] },
        5 : { "isColor" : False, "code" : f"{path}/IMAGES/sanscrit.png", 'position' : [20, 10] },
        6 : { "isColor" : False, "code" : f"{path}/IMAGES/folded.png", 'position' : [20, 10] },
        7 : { "isColor" : False, "code" : f"{path}/IMAGES/imageOne.png", 'position' : [20, 10] },
        8 : { "isColor" : False, "code" : f"{path}/IMAGES/imageTwo.png", 'position' : [20, 10] },
}
