...
_NAME = "اسم"
_API = "API"
_CAPTION = "التسمية التوضيحية"
_BACK_HOME = "   العودة إلى المنزل"
_INSTRUCTIONS = "🛈 تعليمات 🛈"
_HOME_A = "مرحبًا {} .. !!\n مرحبًا بك في {}.!\n\n باستخدام هذه الأداة ، يمكنك بسهولة تحويل الصور إلى PDF وضغط ملفات PDF وتقسيم ملفات PDF ودمجها وتشفيرها وفك تشفيرها وتدوير صفحات PDF وغير ذلك الكثير.\n\n أرسل لي ببساطة ملف PDF / IMAGE وسيقوم بتنفيذ الإجراء المطلوب. للحصول على المساعدة ، حدد  ⚠️ مساعدة ⚠️  في أي وقت. يتوفر برنامج PDF الآلي هنا لتسهيل حياتك ..\n\n جربه الآن وشاهد كيف يمكن أن يساعدك في تلبية جميع احتياجات PDF الخاصة بك!"
_HOME_B = "صفحة الإعدادات ⚙️\n\n اسم المستخدم: {}\n معرّف المستخدم: {}\n اسم المستخدم: {}\n تاريخ التسجيل: {}\n\n اللغة: {}\n الواجهة: {}\n العدد: {}\n العرض: {}\n اسم الملف: {}"
_HOME_C = "** بعض الميزات الرئيسية هي: **\n\n ◍ `` إنشاء ملف PDF من صورك: ما عليك سوى إرساله في bot pms [png ، jpg ، jpeg]   \n ◍ `` استخراج نص من ملف PDF: يساعد في استخراج النص من ملف PDF وإرساله كرسالة منفصلة.   \n ◍ `` تحويل ملف PDF إلى تنسيق ملف آخر: [images، txt، html، json، tar، rar]   \n ◍    دمج ملفات PDF متعددة في ملف واحد: ملفات PDF متعددة لدمجها في ملف واحد   \n ◍    تقسيم ملف PDF إلى صفحات منفصلة: ملف PDF كبير لتقسيمه إلى ملفات منفصلة   \n ◍   استخراج الصور من ملف PDF: [الكل ، النطاق ، الصفحات] كصورة ، مستند ، مضغوط ، رر  \n ◍  يساعد على تقليل الحجم عن طريق تحسين الصور. مفيد في إرسال الملف عبر البريد الإلكتروني عندما يكون كبيرًا جدًا   \n ◍  ` جلب البيانات الوصفية: عنوان المستند ، والمؤلف ، والموضوع ، والكلمات الأساسية المرتبطة بالمستند ، وتواريخ الإنشاء والتعديل   \n ◍ `` تشفير / فك تشفير ملفات PDF باستخدام كلمات المرور ومواقع الويب إلى Pdf والتدوير وإعادة التسمية والطعن ...   \n ◍ `` العلامة المائية ، والجمع ، والتكبير ، والرسم ، وإضافة / حذف الصفحات ، أو Ocr pdf ...` \n ◍` `رسائل نصية إلى ملفات pdf والمزيد .. 😎```"
_HOME_D = "`` كما تعلم ، هذه خدمة مجانية ، لا يمكنني ضمان المدة التي يمكنني خلالها الحفاظ على هذه الخدمة ... \n\n ⚠️ تعليمات ⚠️:\n ◍   يرجى ملاحظة أن البريد العشوائي لا يتم التسامح معه بشكل عام ويمكن أن ينتج عنه في المستخدم أو البوت الذي تم حظره من الخدمة   \n ◍    انتظر حتى يقوم الروبوت بمعالجة الملف: سيقوم الروبوت بمعالجة ملف PDF وتنفيذ الإجراء المطلوب. قد يستغرق هذا بضع دقائق ، اعتمادًا على حجم الملف ومدى تعقيد الإجراء الذي يتم تنفيذه.   \n ◍    بمجرد أن يكمل الروبوت الإجراء ، سيرسل لك النتائج. إذا كان الإجراء ناجحًا ، فستتلقى الإخراج. إذا لم يكن الإجراء ناجحًا ، فسيخبرك الروبوت ويقدم لك أي رسائل خطأ ذات صلة.   \n ◍    سيتم حظر أي مستخدم يوزع أو يشارك محتوى إباحيًا على الروبوت بشكل دائم   \n ** أرسل أي صورة لتبدأ: ** 😁"
_SELECT_LANG = "الآن ، حدد أي لغة .."
_DEFAULT = "الافتراضي ❌"
_CUSTOM = "العرف ✅"
_CANT_USE = "لا يمكن استخدام هذه الميزة ❌"
_WAIT = "الانتظار .. 🥱"
_REPORT = "أبلغ عن أي أخطاء تجدها!"
_ADD = "♻ أضف ♻"
_CHANGE = "♻ التغيير ♻"
_DELETE = "🗑 حذف 🗑"
_SET_THUMB = "الإعداد ⚙️ »الصورة المصغرة 📷"
_SET_NAME = "إعداد ⚙️ »اسم الملف 📷"
_SET_API = "الإعداد ⚙️ »API 📷"
_SET_CAPT = "الإعداد ⚙️ »التسمية التوضيحية 📷"
_SET_LANG = "الإعداد ⚙️ »تغيير اللغة 🌐"
_SEND = "الآن أرسل لي.."
_SEND_FAST = "الآن ، أرسل لي .. 😅\n\n سريع.! ليس لدي المزيد من الوقت لاستعراض النص .. 😏\n\n / إلغاء: للإلغاء"
_ASK_API = "n\n افتح الرابط ** أدناه ** وأرسل لي الرمز السري:"
_LANG_FEED = "تحذير علة! إذا كانت نصوصي تبدو غريبة ، فمن المحتمل أن يكون خطأ ترجمة Google.\n\n الإبلاغ عن خطأ في {} Lang:\n` • تحديد Lang\n • رسالة خطأ\n • رسالة جديدة`"
_RES_SUCCESS = "تم تحديث الإعدادات بنجاح ✅"
_RES_FAIL = "لا يمكن تحديث الإعدادات ❌"
_OPEN_BROW = "🔗 فتح في المتصفح 🔗"
_ERROR_DB = "حدث خطأ ما أثناء استرداد البيانات من قاعدة البيانات"
_START = "رسالة ترحيب .."
_TXT2PDF = "إنشاء ملفات PDF نصية"
_FEEDBACK = "اكتب تعليقًا 📋"
_PG_NUM = "`عدد الصفحات: •{}•` 🌟"
_PDF_REPLY = "`ماذا علي أن أفعل بهذا الملف .؟`\n\nFile Name:` {} `n حجم الملف:` {} `"
_META = "⭐ META £ ATA"
_IMAGE = "🖼️ الصور 🖼️"
_TEXT = "📑 نص 📑"
_ROTATE = "🤸 تدوير 🤸"
_SPLIT_MERGE = "✂️ انقسام / دمج 🧬"
_ENC_DECRYPT = "🔐 التشفير / DECRY 🔓"
_FORMAT = "😗 تنسيق 😗"
_WATERMARK = "💦 علامة مائية 💦"
_COMP_OCR = "🗜 COMPRESS / OCR"
_RENAME = "✏️ إعادة تسمية ✏️"
_ZOOM = "🔎 التكبير 🔎"
_URL = "🔗 URL 🔗"
_FILTER = "👻 فلاتر 👻"
_ADD_DELETE = "🟢 إضافة / DLT 🔴"
...
_BAN_G = "{} لا تتوقع أبدًا ردًا جيدًا مني\n\n منعني المسؤولون من العمل هنا .. 🤭"
_BAN_CB = "عفوًا ، آسف لكسر قلبك ، هذه الرسالة ليست لك 💔.\n\n حظ أفضل في المرة القادمة! 😏"
_FOOL = "من فضلك لا تحاول خداعى .. 🤭"
_CREATE_BOT = "قم بإنشاء الروبوت الخاص بك"
_FORCE = "انتظر [{}] (tg: // user؟ id = {}) .. !!\n\n بسبب حركة المرور الهائلة فقط ** أعضاء القناة ** يمكنهم استخدام هذا الروبوت 🚶\n هذا يعني أنك بحاجة إلى ** انضم إلى ** القناة المذكورة أدناه لاستخدامي!\n\n انقر على    إعادة المحاولة    بعد الانضمام .. 😅"
_JOIN_CHANNEL =  "🌟 JOIN CHANNEL 🌟"
_REFRESH = "♻️ تحديث ♻️"
_BACK = "خلف"
_H_META = "❓ META £ ATA: مساعدة ❓"
_H_ENC = "❓ تشفير / فك: مساعدة ❓"
_ONLY_META = "✔ البيانات الوصفية فقط ✔"
_ALL_META = "✅ مع معاينة ✅"
_H_SPLIT_MERGE = "❓ انقسام / دمج PDF: مساعدة ❓"
_H_SPLIT = "✂️ انقسام ✂️"
_H_MERGE = "🧬 دمج 🧬"
_H_FORMAT = "❓ التنسيق: مساعدة ❓"
_H_COMP_OCR = "❓ COMPRESS / OCR PDF: مساعدة ❓"
_H_COMPRESS = "🗜 ضغط 🗜"
_H_OCR = "📝 التعرف الضوئي على الحروف 📝"
_H_WATERMARK = "❓ علامة مائية: مساعدة ❓"
_H_WATER = "💦 علامة مائية 💦"
_H_STAMP = "™ ️ STAMP ™ ️"
_H_FILTER = "❓ الفلتر: مساعدة ❓"
_H_DRAW = "🎨 رسم 🎨"
_H_BAW = "⚫ أسود / أبيض ⚪"
_H_SAT = "🪐 SATURARE 🪐"
_H_INV = "🖌 عكس 🖌"
_H_ADD_DEL = "❓ إضافة / حذف الصفحات: مساعدة ❓"
_ADD = "🟢 إضافة صفحات"
_DEL = "🔴 حذف الصفحات 🔴"
_P2IMG = "⚙️ PDF »الصور ↓"
_P2IMG_ = "⚙️ PDF »الصور» {} ↓"
...
_B_TEXT_T = "💬 نص 💬"
_B_PDF = "📎 PDF 📎"
_WATER_OP = "⚙️ PDF »علامة مائية» {} »OPCACiTY ↓"
_WATER_PO = "⚙️ PDF »علامة مائية» موقع"
_TOP = "⬆️ ToP ⬆️"
_MIDDLE = "↔️ MiDDLE ↔️"
_BOTTOM = "⬇️ BoTToM ⬇️"
_WATER_COLOR = "⚙️ PDF »علامة مائية» كولور ↓"
_B_STAMP = "⚙️ PDF »طابع ↓"
_STAMP_COLOR = "⚙️ PDF »طابع» لون ↓"
_PROGRESS = "n ** تم ✅: ** {0} / {1}\n ** السرعة 🚀: ** {2} / ثانية\n ** الوقت المقدر ⏳: ** {3}"
_UPLOADING = "جارٍ التحميل"
_CANCEL = "🎯 إلغاء 🎯"
_NO_QUEUE = " لم يتم العثور على قائمة انتظار ... "
_NO_IMG = "لم يتم العثور على صورة. !! 😒"
_DL_IMG = "تم تنزيل {} الصور 🥱"
_GEN_PDF = "اسم الملف: '{} `\n الصفحات:` {} `"
_REN_PDF = "أرسل لي الآن اسم ملف:"
_DLT_QUEUE = " تم حذف قائمة الانتظار بنجاح ..`🤧"
...
_CONVERT = "`المحولة: {} إلى {}`"
_UNSUPPORT = "ملف غير مدعوم ..🙄`"
_ADMIN_ONLY = "بسبب بعض حدود Telegram ..\n\n لا يمكنني العمل إلا كمسؤول\n__ الرجاء ترقيتي كمسؤول__ ☺️"
_NOT_DOC = "بروه الرجاء الرد على وثيقة او صورة ..🤧"
_G_ADMIN = "يمكن فقط لمسؤولي المجموعة استخدام هذا الروبوت\n تعال مرة أخرى إلى بلدي Pm 😋"
_NOT_YOUR = " يمكن للمسؤولين فقط القيام بذلك ... \n\n أو جرّب ملفات pdf (__ الرد على رسالتك__)"
_WASTE = " لا أحد سيساعدك  😏"
_GENERATE ="📚 توليد 📚"
_HD = "الآن Image To PDF في وضع HD 😈"
_BACK_DEFAULT = "   العودة إلى الجودة الافتراضية"
_NO_API = "`الرجاء إضافة تحويل API .. 💩\n\n ابدأ» إعدادات »api» إضافة / تغيير`"
_ERROR = "حدث خطأ ما .. 🐉\n\n الخطأ: `{}`"
_NOT_DOKR = " الملف غير مدعوم ، انشر الروبوت باستخدام عامل الإرساء "
...
_H_AIO = "❓ ملف الإدخال: مساعدة ❓"
_YES = "✅ نعم ✅"
_NO = "🔴 لا 🔴"
_MOVE = "⏭ تحرك ⏭"
_WAIT_TXT = "الآن أرسل لي أي رسالة نصية .. 😪"
_AIO_QN = "`ماذا علي أن أفعل بهذا الملف .؟`🤔💭\n\nInput:\n	 اسم الملف:` {} `n \ t حجم الملف:` {} `n \ t كلمة المرور: || • {} • | |\n\n الإخراج:\n \ t اسم الملف: `• {} •`\n \ t العلامة المائية: `• {} •`\n \ t كلمة المرور: || • {} • ||"
_PREVIEW = "📸 معاينة 📸"
_PROCEED = "🆗 عملية 🆗"
_EXIT = " العملية ملغاة ...  😏"
_NOTHING = "لا شيء لخلق .. 😏"
_TEXT2PDF = "`` إنشاء ملف PDF من الرسائل النصية »'"
_TEXT2PDF_S = "بدأ في تحويل txt إلى Pdf.."
_TEXT2PDF_T = "__TEXT TO PDF »الآن ، الرجاء إدخال العنوان: __\n\n / خروج __ لإلغاء __\n / تخطي __للتخطي__"
...
_CANCELED = "العملية ملغاة .. 😏"
_NOT_ENCRYPT = "الملف غير مشفر .. 👀"
_NOTHING_OFF = "لا شيء رسمي حيال ذلك .. 😅"
_SEARCH = "️♻️ بحث ♻️"
_OPEN_BOT = "😇 فتح في بوت 😇"
_TOTAL = "إجمالي {} النتائج .."
_H_LANG = "تساعد في ضبط لغتك المريحة 😇"
_SEARCH_PDF = "ابحث عن ملف PDF 🔍"
_SEARCH_DES = "يمكنك الآن البحث في مكتبة ضخمة من مستندات PDF بكل سهولة ويسر. باستخدام وضع البحث المضمن ، يمكنك ببساطة كتابة اسم المستند الذي تبحث عنه"
_MIN_SEARCH = "🔎 اكتب للبحث عن ملفات PDF .."
_NO_RESULT = "🤐 لا توجد نتائج لـ  {} "
_GET_PDF = "⚔ احصل على PDF"
_OLD_QUEUE = "قائمة الانتظار القديمة .. جرب واحدة جديدة .. 🙄"
_INLINE_CAP = "MD5: {}\n العنوان: ** {}. **\n المؤلف: ** {}. **\n\n المجلد: {}\n السنة: {}\n الصفحات: {}\n اللغة: {}\n الناشر: {}"
...
_ASK_PG = "الرجاء إدخال بناء جملة صفحة PDF التي تريد استخدامها ،\n\n بناء الجملة:\n \ t نطاق الصفحة: `[البداية ، النهاية]` ،\n \ t صفحة محددة: `مفصولة بفواصل`.\n\n مثال:  1،3،5،12: 19 "
...
_MORE_PGS = "يحتوي على عدد كبير جدًا من الصفحات ، أرسل لي ملف pdf أقل من 5 صفحات 😐"
...
_URL_TYPE = " 🔗 إنشاء ... \n\n ** عام ** 📢:\n__ سيكون الملف الذي يتم الوصول إليه عبر هذا الرابط متاحًا للجمهور ، مما يسمح لأي شخص بحفظه وإعادة توجيهه __.\n\n ** حماية ** 🔐:\n__ ضمانات سرية الرسالة من خلال منع إعادة توجيهها وحفظها _."
_NOTIFY_CB = "🔔 إشعار 🔔"
_MUTE_CB = "🔕 كتم الصوت 🔕"
_PUBLIC = "📢 عامة 📢"
_PRIVATE = "🔐 خاص 🔐"
_GEN_LINK = "**ها هو! هذا ما كنت تبحث عنه .. **"
_ERROR_ = "عفوًا ، يبدو أنه حدث خطأ ما. يرجى المحاولة لاحقًا.\n\n` الخطأ: `{}"
_AIO_PROCESS = "```{} العمل قيد التقدم ..🔰 \ n قد يستغرق الأمر بعض الوقت .. 💔```"
_VIEW_ONLY = "قام الرابط بتقييد الوصول للعرض فقط .. 👀"
_REFER_T = "🎁 رابط الإحالة 🎁"
_REFER_D = "ادع صديقك .."
_CLICK_RIGHT = "انقر فوق زر الجانب الأيمن للتحديد. 👉"
_REFER = "يرجى إحالة ما لا يقل عن 5 مستخدمين جدد لاستخدام هذا الروبوت 😑 \n\nYOUR REFERRAL LINK: {}"
