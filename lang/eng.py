...
BUTTONS = {
    ...
    "format" : { "☝️ SINGLE ☝️" : "#1-format", "✌ DOUBLE[HORIZONTAL] ✌" : "#2-format-H", "✌ DOUBLE[VERTICAL] ✌" : "#2-format-V",
                "🤟 TRIBLE[HORIZONTAL] 🤟" : "#3-format-H", "🤟 TRIBLE[VERTICAL] 🤟" : "#3-format-V", "😂 FOURBLE 😂" : "#4-format", "« BACK «" : "pdf" },
